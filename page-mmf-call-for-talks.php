...
<div class="container mt-5 pb-5" style="min-height: 100vh">
    <div class="row">
        <div class="col">
            <h1>Vortrags- und Workshopanmeldung für die Mini Maker Faire Heilbronn 2020</h1>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col">
            <?php if (isset($guid)) : ?>
                ...
                <?php else : ?>
                    ...
                    <h3 class="mt-5">Deine Einreichung</h3>

                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="reg_projektname">Titel deiner Einreichung</label>
                    ...
                    <div class="form-group">
                        <label for="reg_kurzbeschreibung"> Beschreib deine Einreichung in einem Satz. </label>
                    ...
                    <div class="form-group">
                        <label for="reg_beschreibung"> Beschreib deine Einreichung etwas ausführlicher. </label>
